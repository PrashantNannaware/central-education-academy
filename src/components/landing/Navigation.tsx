    ...
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl z-50">
      <div className="glass-panel rounded-full px-6 py-4 flex items-center justify-between shadow-lg backdrop-blur-md">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#courses" className="text-neutral-600 hover:text-primary transition-colors font-medium">Courses</a>
          <a href="#schedule" className="text-neutral-600 hover:text-primary transition-colors font-medium">Schedule</a>
          <a href="#testimonials" className="text-neutral-600 hover:text-primary transition-colors font-medium">Testimonials</a>
      ...
      {isMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-4">
            <a href="#courses" className="text-neutral-600 hover:text-primary transition-colors font-medium px-4 py-2 hover:bg-neutral-200/50 rounded-lg">Courses</a>
            <a href="#schedule" className="text-neutral-600 hover:text-primary transition-colors font-medium px-4 py-2 hover:bg-neutral-200/50 rounded-lg">Schedule</a>
            <a href="#testimonials" className="text-neutral-600 hover:text-primary transition-colors font-medium px-4 py-2 hover:bg-neutral-200/50 rounded-lg">Testimonials</a>
